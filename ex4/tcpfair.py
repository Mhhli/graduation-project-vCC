...
#                    default=100)
parser.add_argument('--bw-ecn-host', '-eB',
                    type=float,
                    help="Bandwidth of host links (Mb/s)",
                    default=100)
parser.add_argument('--bw-non-ecn-host', '-neB',
                    type=float,
                    help="Bandwidth of host links (Mb/s)",
                    default=100)
...
def tcpfair():
    ...
    topo = StarTopo(n=args.hosts, bw_ecn_host=args.bw_ecn_host, bw_non_ecn_host=args.bw_non_ecn_host, 
